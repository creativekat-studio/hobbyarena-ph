...
export function getEmailLogoUrl() {
  loadLocalEnv();
  const base = process.env.PUBLIC_SITE_URL || EMAIL_BRAND.siteUrl;
          ...
          <tr>
            <td style="font-family:${FONT}">
              ...
              <p style="margin:0 0 8px;font-family:${FONT};font-size:12px;line-height:1.6;color:${c.muted}">
                ${footerNote || "Reply to this email if you have questions — it goes straight to our team."}
              </p>
              <p style="margin:0;font-family:${FONT};font-size:12px;color:${c.muted}">
                <a href="${EMAIL_BRAND.siteUrl}" style="color:${c.muted};text-decoration:none">${EMAIL_BRAND.siteUrl.replace(/^https?:\/\//, "")}</a>
                <span style="color:${c.faint}"> · </span>
                <a href="mailto:${EMAIL_BRAND.supportEmail}" style="color:${c.muted};text-decoration:none">${EMAIL_BRAND.supportEmail}</a>
              </p>
